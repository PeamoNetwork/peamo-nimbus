...
static void sceneInit(void)
{
	...
	C2D_SpriteFromSheet(&mainStruct.peamo_unloaded_deselected, spriteSheet, sheet_peamo_unloaded_deselected_idx);
	C2D_SpriteFromSheet(&mainStruct.peamo_unloaded_selected, spriteSheet, sheet_peamo_unloaded_selected_idx);
	C2D_SpriteFromSheet(&mainStruct.peamo_loaded_selected, spriteSheet, sheet_peamo_loaded_selected_idx);
	C2D_SpriteFromSheet(&mainStruct.peamo_loaded_deselected, spriteSheet, sheet_peamo_loaded_deselected_idx);
	...
	C2D_SpriteSetPos(&mainStruct.peamo_loaded_selected, 49, 59);
	C2D_SpriteSetPos(&mainStruct.peamo_unloaded_selected, 49, 59);
	C2D_SpriteSetPos(&mainStruct.peamo_unloaded_deselected, 49, 59);
	C2D_SpriteSetPos(&mainStruct.peamo_loaded_deselected, 49, 59);
